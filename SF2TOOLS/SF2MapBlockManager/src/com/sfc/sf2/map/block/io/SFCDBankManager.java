...
public class SFCDBankManager {
    ...
    public MapBlock[] importSFCDBank(Tile[] tileset, byte[] inputData){
        ...
        try{
            this.palette = tileset[0].getPalette();
    ...
    private void outputInitialBlocks(){
        ...
        outputData.add((short)(0x22E-80));
        outputData.add((short)(0x22F-80));
        outputData.add((short)(0xA2E-80));
        outputData.add((short)(0x23E-80));
        outputData.add((short)(0x23F-80));
        outputData.add((short)(0xA3E-80));
        outputData.add((short)(0x24E-80));
        outputData.add((short)(0x24F-80));
        outputData.add((short)(0xA4E-80));
        
        outputData.add((short)(0x22C-80));
        outputData.add((short)(0x22D-80));
        outputData.add((short)(0xA2C-80));
        outputData.add((short)(0x23C-80));
        outputData.add((short)(0x23D-80));
        outputData.add((short)(0xA3C-80));
        outputData.add((short)(0x24E-80));
        outputData.add((short)(0x24F-80));
        outputData.add((short)(0xA4E-80));
    ...
    private int getNextBit(){
     ...
     public void exportSFCDBank(MapBlock[] blocks, String filePath){
