...
public class MainEditor extends javax.swing.JFrame {
        ...
        jTextField9.setText(".\\");
            ...
            jTextField11.setText(".\\");
                ...
                jTextField12.setText(".\\");
                    ...
                    jLabel4.setText("<html>Select a directory with \"backgroundXX.gif\" files.<br>Required GIF Format : 4BPP / 16 indexed colors.<br>Transparent color at index 0.</html>");
                        ...
                        .addGroup(jPanel6Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel6Layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(jTextField12, javax.swing.GroupLayout.DEFAULT_SIZE, 323, Short.MAX_VALUE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    jTextField13.setText(".\\");
                            ...
                            .addGroup(jPanel11Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel11Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jTextField13, javax.swing.GroupLayout.DEFAULT_SIZE, 316, Short.MAX_VALUE)
                                        .addGap(10, 10, 10)
                        ...
                        jTextField15.setText(".\\");
                            ...
                            jTextField16.setText(".\\");
                                ...
                                jLabel13.setText("<html>Select a directory to create new \"backgroundXX.gif\" files.<br>Exported GIF Format : 4BPP / 16 indexed colors.<br>Transparent color at index 0.</html>");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        backgroundManager.exportDisassembly(jTextField13.getText());
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        backgroundManager.exportPng(jTextField15.getText());
    }//GEN-LAST:event_jButton13ActionPerformed

    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        backgroundManager.importPng(jTextField11.getText());
        jPanel2.removeAll();
        Tile[] tiles = backgroundManager.getTiles();        
        jPanel2.setLayout(new GridLayout(1,1));
        BackgroundLayout backgroundLayout = new BackgroundLayout();
        backgroundLayout.setTiles(tiles);
        jPanel2.add(backgroundLayout);
        jPanel2.setSize(backgroundLayout.getWidth(), backgroundLayout.getHeight());
        jPanel2.revalidate();
        jPanel2.repaint();  
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        backgroundManager.importDisassembly(jTextField9.getText());
        jPanel2.removeAll();
        Tile[] tiles = backgroundManager.getTiles();        
        jPanel2.setLayout(new GridLayout(1,1));
        BackgroundLayout backgroundLayout = new BackgroundLayout();
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        backgroundManager.importGif(jTextField12.getText());
        jPanel2.removeAll();
        Tile[] tiles = backgroundManager.getTiles();        
        jPanel2.setLayout(new GridLayout(1,1));
        BackgroundLayout backgroundLayout = new BackgroundLayout();
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        backgroundManager.exportGif(jTextField16.getText());
