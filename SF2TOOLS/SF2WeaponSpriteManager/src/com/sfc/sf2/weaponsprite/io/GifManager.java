...
public class GifManager {
    ...
    public static WeaponSprite importGif(String filepath){
        System.out.println("com.sfc.sf2.weaponsprite.io.GifManager.importGif() - Importing GIF file ...");
        ...
        try{
             ...
             System.err.println("com.sfc.sf2.weaponsprite.io.GifManager.importGif() - Error while parsing graphics data : "+e);
        }        
        System.out.println("com.sfc.sf2.weaponsprite.io.GifManager.importGif() - GIF file imported.");
        return weaponsprite;                
    }
    ...
    public static Tile[] loadGifFile(String filepath) throws IOException{
        ...
        try{
            ...
            if(path.toFile().exists()){
             ...
             System.err.println("com.sfc.sf2.weaponsprite.io.GifManager.importGif() - Error while parsing GIF data : "+e);
             throw e;
        }                
        return tiles;                
    }
    ...
    private static Color[] buildColors(IndexColorModel icm){
        ...
        if(icm.getMapSize()>16){
            System.out.println("com.sfc.sf2.weaponsprite.io.GifManager.buildColors() - GIF FORMAT HAS MORE THAN 16 INDEXED COLORS : "+icm.getMapSize());
        }
    ...
    public static void exportGif(WeaponSprite weaponsprite, String filepath){
        try {
            //System.out.println("com.sfc.sf2.weaponsprite.io.GifManager.exportGif() - Exporting GIF files ...");
            writeGifFile(weaponsprite.getTiles(),filepath);    
            //System.out.println("com.sfc.sf2.weaponsprite.io.GifManager.exportGif() - GIF files exported.");
        } catch (Exception ex) {
    ...
    public static void writeGifFile(Tile[] tiles, String filepath){
        try {
            //System.out.println("com.sfc.sf2.weaponsprite.io.GifManager.exportGif() - Exporting GIF file ...");
