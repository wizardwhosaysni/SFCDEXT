...
' Do While Count <= UBound(CharacterName())
 ...
 If Index - JEWELENDSCREENLAYOUT_ORIGINAL_OFFSET > 500 And isExpanded = False Then
 ...
 'Wiz note : this address is the Jewel End Screen Layout pointer. Why manipulate it ?
 ...
 If RomDump(CLASSDATAPOINTER_ORIGINAL_OFFSET + 1 + 2) < 254 Then
   RomDump(CLASSDATAPOINTER_ORIGINAL_OFFSET + 1 + 2) = RomDump(CLASSDATAPOINTER_ORIGINAL_OFFSET + 1 + 2) + 2
 Else
   If RomDump(CLASSDATAPOINTER_ORIGINAL_OFFSET + 1 + 2) = 254 Then
     RomDump(CLASSDATAPOINTER_ORIGINAL_OFFSET + 1 + 2) = 0
   Else
     RomDump(CLASSDATAPOINTER_ORIGINAL_OFFSET + 1 + 2) = 1
   End If
 
   RomDump(CLASSDATAPOINTER_ORIGINAL_OFFSET + 1 + 1) = RomDump(CLASSDATAPOINTER_ORIGINAL_OFFSET + 1 + 1) + 1
 End If
  
 
 'Update Join Data Pointer
 If RomDump(ALLYSTARTDATA_ORIGINAL_OFFSET + 1 + 2) < 254 Then
   RomDump(ALLYSTARTDATA_ORIGINAL_OFFSET + 1 + 2) = RomDump(ALLYSTARTDATA_ORIGINAL_OFFSET + 1 + 2) + 2
 Else
   If RomDump(ALLYSTARTDATA_ORIGINAL_OFFSET + 1 + 2) = 254 Then
     RomDump(ALLYSTARTDATA_ORIGINAL_OFFSET + 1 + 2) = 0
   Else
     RomDump(ALLYSTARTDATA_ORIGINAL_OFFSET + 1 + 2) = 1
   End If
 
   RomDump(ALLYSTARTDATA_ORIGINAL_OFFSET + 1 + 1) = RomDump(ALLYSTARTDATA_ORIGINAL_OFFSET + 1 + 1) + 1
 End If
...
'''  Next Index
 ...
 If RomDump(ALLYSTATS_ORIGINAL_OFFSET + 1 + 2 + 4 * Index) < 254 Then
   RomDump(ALLYSTATS_ORIGINAL_OFFSET + 1 + 2 + 4 * Index) = RomDump(ALLYSTATS_ORIGINAL_OFFSET + 1 + 2 + 4 * Index) + 2
 Else
   If RomDump(ALLYSTATS_ORIGINAL_OFFSET + 1 + 2 + 4 * Index) = 254 Then
     RomDump(ALLYSTATS_ORIGINAL_OFFSET + 1 + 2 + 4 * Index) = 0
   Else
     RomDump(ALLYSTATS_ORIGINAL_OFFSET + 1 + 2 + 4 * Index) = 1
   End If

   RomDump(ALLYSTATS_ORIGINAL_OFFSET + 1 + 1 + 4 * Index) = RomDump(ALLYSTATS_ORIGINAL_OFFSET + 1 + 1 + 4 * Index) + 1 '' 2 isn't the same number as 1 lolololol
 End If
...
Private Sub cmdRemoveSpell_Click()
 ...
 'Update 01010101 Pointer
 If RomDump(JEWELENDSCREENLAYOUTPOINTER_ORIGINAL_OFFSET + 1 + 2) > 1 Then
   RomDump(JEWELENDSCREENLAYOUTPOINTER_ORIGINAL_OFFSET + 1 + 2) = RomDump(JEWELENDSCREENLAYOUTPOINTER_ORIGINAL_OFFSET + 1 + 2) - 2
 Else
   If RomDump(JEWELENDSCREENLAYOUTPOINTER_ORIGINAL_OFFSET + 1 + 2) = 1 Then
     RomDump(JEWELENDSCREENLAYOUTPOINTER_ORIGINAL_OFFSET + 1 + 2) = 255
   Else
     RomDump(JEWELENDSCREENLAYOUTPOINTER_ORIGINAL_OFFSET + 1 + 2) = 254
   End If
 ...
 'Update Class Pointer
 If RomDump(CLASSDATAPOINTER_ORIGINAL_OFFSET + 1 + 2) > 1 Then
   RomDump(CLASSDATAPOINTER_ORIGINAL_OFFSET + 1 + 2) = RomDump(CLASSDATAPOINTER_ORIGINAL_OFFSET + 1 + 2) - 2
 Else
   If RomDump(CLASSDATAPOINTER_ORIGINAL_OFFSET + 1 + 2) = 1 Then
     RomDump(CLASSDATAPOINTER_ORIGINAL_OFFSET + 1 + 2) = 255
   Else
     RomDump(CLASSDATAPOINTER_ORIGINAL_OFFSET + 1 + 2) = 254
   End If
 ...
 'Update Join Data Pointer
 If RomDump(ALLYSTARTDATA_ORIGINAL_OFFSET + 1 + 2) > 1 Then
   RomDump(ALLYSTARTDATA_ORIGINAL_OFFSET + 1 + 2) = RomDump(ALLYSTARTDATA_ORIGINAL_OFFSET + 1 + 2) - 2
 Else
   If RomDump(ALLYSTARTDATA_ORIGINAL_OFFSET + 1 + 2) = 1 Then
     RomDump(ALLYSTARTDATA_ORIGINAL_OFFSET + 1 + 2) = 255
   Else
     RomDump(ALLYSTARTDATA_ORIGINAL_OFFSET + 1 + 2) = 254
   End If
...
''  Next Index
 ...
 If RomDump(ALLYSTATS_ORIGINAL_OFFSET + 1 + 2 + 4 * Index) > 1 Then
   RomDump(ALLYSTATS_ORIGINAL_OFFSET + 1 + 2 + 4 * Index) = RomDump(ALLYSTATS_ORIGINAL_OFFSET + 1 + 2 + 4 * Index) - 2
 Else
   If RomDump(ALLYSTATS_ORIGINAL_OFFSET + 1 + 2 + 4 * Index) = 1 Then
     RomDump(ALLYSTATS_ORIGINAL_OFFSET + 1 + 2 + 4 * Index) = 255
   Else
     RomDump(ALLYSTATS_ORIGINAL_OFFSET + 1 + 2 + 4 * Index) = 254
   End If
 
   RomDump(ALLYSTATS_ORIGINAL_OFFSET + 1 + 1 + 4 * Index) = RomDump(ALLYSTATS_ORIGINAL_OFFSET + 1 + 1 + 4 * Index) - 1
 End If
...
Private Function GetOffsetAddress(iIndex As Long) As Long
 ...
 Count = ALLYSTATS_ORIGINAL_OFFSET + 1
