...
public class MainEditor extends javax.swing.JFrame {
    ...
    BattleMapCoordsLayout battlemapcoordsLayout = null;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String mapCoordsPath = jTextField15.getText();
        BattleMapCoords[] coords = ((BattleMapCoordsTableModel)jTable1.getModel()).getCoords();
        battlemapcoordsManager.exportDisassembly(coords, mapCoordsPath);
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        ...
        selectedCoords = 1;
        selectedMapIndex = coords[selectedCoords].getMap();
        
        final String[][] mapEntries = battlemapcoordsManager.getMapEntries();
        ...
        battlemapcoordsLayout = new BattleMapCoordsLayout();
        ...
        battlemapcoordsLayout.setDrawGrid(true);
        battlemapcoordsLayout.setDrawCoords(true);
        
        jTable1.setModel(new BattleMapCoordsTableModel(coords, battlemapcoordsLayout));
        ...
        jPanel2.add(battlemapcoordsLayout);
        jPanel2.setSize(battlemapcoordsLayout.getWidth(), battlemapcoordsLayout.getHeight());
