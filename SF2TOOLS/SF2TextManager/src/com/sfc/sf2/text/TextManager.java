...
public class TextManager {
    ...
    public static void importVWFontAndOptimize(String path){
        System.out.println("com.sfc.sf2.text.TextManager.importVWFontAndOptimize() - Optimizing text ...");
        TextManager.gamescript = VWFontOptimizingManager.importVWFontAndOptimize(path, TextManager.gamescript);
        System.out.println("com.sfc.sf2.text.TextManager.importVWFontAndOptimize() - Text optimized.");
    }
